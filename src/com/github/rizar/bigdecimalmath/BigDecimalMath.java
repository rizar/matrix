package com.github.rizar.bigdecimalmath;
...
{
    public static int BIG_PRECISION = 100;
    ...
    public static BigDecimal sqrt(BigDecimal squarD)
    {
        // TODO odd scale
        return sqrt(squarD, BIG_PRECISION);
    }
}
